<script>
  ...
  onMount(async () => {
    ...
    setInterval(totalGanancias, 5000);
  });
  ...
  let totalBill = 0; //total ganancias con las facturas
  ...
  //función saca el número de platos
  async function numeroPlatos() {
    let platos = await fetch("/api/numberOfPlates").then((r) => r.json());
    numberPlates = platos;
  }

  //función saca las ganancias totales
  async function totalGanancias() {
    let total = await fetch("/api/totalGanancias").then((r) => r.json());
    totalBill = total;
  }
</script>
    ...
    <nav id="header" class="bg-white fixed w-full z-10 top-0 shadow">
      ...
      >
        <div class="w-1/2 pl-2 md:pl-0">
          <p class="text-2xl fas fa-moon text-Blue-100 pr-3 sm:text-Red-200">
            Ranni
          </p>
        </div>
                ...
                <div class="flex-1 text-right md:text-center">
                  ...
                  <h3 class="font-bold text-3xl">
                    ...
                    <span class="text-pink-500"
                      ><i class="fas fa-exchange-alt" /></span
                    >
                  </h3>
                </div>
              </div>
              ...
              <div class="flex flex-row items-center">
                <div class="flex-shrink pr-4">
                  <div class="rounded p-3 bg-blue-600">
                    <i class="fas fa-utensils fa-2x fa-fw fa-inverse" />
                  </div>
                </div>
                <div class="flex-1 text-right md:text-center">
                  <h5 class="font-bold uppercase text-gray-500">
